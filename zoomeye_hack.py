            ...
            try:
                ...
                while count < len(json_object["matches"]):
                    try:
                        ...
                        print("\033[1;94mport\033[1;00m:\033[1;92m", json_object["matches"][count]["portinfo"]["port"], "\033[1;94mservice\033[1;00m:\033[1;92m", json_object["matches"][count]["portinfo"]["app"], "\033[1;94mversion\033[1;00m:\033[1;92m", json_object["matches"][count]["portinfo"]["version"], "\033[1;94mtransport\033[1;00m:\033[1;92m", json_object["matches"][count]["protocol"]["transport"], "\033[1;94mhoneypot\033[1;00m:\033[1;92m", json_object["matches"][count]["honeypot"], "\033[1;00m")
                        items_for_short_report.append("port: " + str(json_object["matches"][count]["portinfo"]["port"]) + " service: " + json_object["matches"][count]["portinfo"]["app"] + " version: " + json_object["matches"][count]["portinfo"]["version"] + " transport: " + str(json_object["matches"][count]["protocol"]["transport"]) + " honeypot: " + str(json_object["matches"][count]["honeypot"]))
                    count += 1
                try:
                    print("\033[1;94mcountry\033[1;00m:\033[1;92m", json_object["matches"][0]["geoinfo"]["country"]["code"], "\n\033[1;94mcity\033[1;00m:\033[1;92m", json_object["matches"][0]["geoinfo"]["city"]["names"]["en"], "\n\033[1;94mlatitude\033[1;00m:\033[1;92m", json_object["matches"][0]["geoinfo"]["location"]["lat"], "\n\033[1;94mlongitude\033[1;00m:\033[1;92m", json_object["matches"][0]["geoinfo"]["location"]["lon"], "\n\033[1;94misp\033[1;00m:\033[1;92m", json_object["matches"][0]["geoinfo"]["isp"], "\033[1;00m")
                    items_for_short_report.append("country: " + json_object["matches"][0]["geoinfo"]["country"]["code"] + "\ncity: " + json_object["matches"][0]["geoinfo"]["city"]["names"]["en"] + "\nlatitude: " + str(json_object["matches"][0]["geoinfo"]["location"]["lat"]) + "\nlongitude: " + str(json_object["matches"][0]["geoinfo"]["location"]["lon"]) + "\nisp: " + json_object["matches"][0]["geoinfo"]["isp"])
                except IndexError:
                    pass
                except TypeError:
                    pass
